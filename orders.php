...
$table=$_GET['table'];
    ...
    $req1="select * from `orders` where etap != 3 and num_table='$table';";
...
?>
      <div class="box">
         <p> placed on : <span><?php echo $row['date']; ?></span> </p>
         <p> table : <span><?php echo $row['num_table']; ?></span> </p>
         <p> your orders : <span><?php echo $row1['nom']; ?></span> </p>
         <p> price : <span><?php echo $row1['prix']; ?></span> </p>
         <p> status : <span><?php 
         if($row['etap']==0)
         echo "inverified";
         if($row['etap']==1)
         ...
         echo "finsh";
         ?></span> </p>
         <p> nom du serveur : <span><?php
         $req11="select * from `admin` where id=".$row['id_serveur'];
         $res11=mysqli_query($conn,$req11);
         $row11=mysqli_fetch_assoc($res11);
         
         echo $row11['nom']; ?></span> </p>
      </div>
...
?>    
   ...
   <div class="cart-total">
      ...
      <p></p>
      <a  class="btn">Total : <span><?php echo $prictotale." DT"; ?></span></a>
      </div>
   </div>
