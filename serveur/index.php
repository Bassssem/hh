...
<?php 
    ...
    $req="SELECT DISTINCT `num_table` FROM `orders` where etap = 0;";
              ...
              <div class="content-card" data-testimonials-item>
                ...
                <div class="testimonials-text" data-testimonials-text>
                  ...
                  <div class="item">
                   ...
                   <?php  $sql = "SELECT * FROM `orders` WHERE etap = 0 and num_table=".$row['num_table'];
...
<?php } ?>
        ...
        <section class="testimonials">
          ...
          <h3 class="h3 testimonials-title">ili 7adhrin:</h3>

          <ul class="testimonials-list has-scrollbar">

<?php 

    $req="SELECT DISTINCT `num_table` FROM `orders` where etap = 2;";
    $result = mysqli_query($conn, $req);
    while($row = mysqli_fetch_assoc($result)){
              ...
              <div class="content-card" data-testimonials-item>
                ...
                <div class="testimonials-text" data-testimonials-text>
                  ...
                  <div class="item">
                   ...
                   <?php  $sql = "SELECT * FROM `orders` WHERE etap = 2 and num_table=".$row['num_table']." and id_serveur = ".$_SESSION['id'];
                    $result1 = mysqli_query($conn, $sql);
                    while($row1 = mysqli_fetch_assoc($result1)){
                  ...
                  <a href="setmodife.php?idor5als=<?php echo $row['num_table']; ?>"><button> c'est bon 5loset</button></a>
                </div>
