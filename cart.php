...
while($row=mysql_fetch_assoc($res)){
    ...
    $req1="select * from `produit` where id='$id_produit';";
    $res1=mysql_query($req1);
    $row1=mysql_fetch_assoc($res1);
    $prictotale += $row1['prix'];
    
?>
      <div class="box">
         <a href="quick_view.html" class="fas fa-eye"></a>
         <a href="cart.php?table=<?php echo $table; ?>&idsp=<?php echo $row['id']; ?>" class="fas fa-times" onclick="return confirm('delete from cart?');"></a>
         <img src="uploaded_img/<?php echo $row1['image']; ?>" alt="">
         <div class="name"><?php echo $row1['nom']; ?></div>
         <div class="flex">
            <div class="price"><span>DT</span><?php echo $row1['prix']; ?></div>
         </div>
...
?>
   ...
   <div class="cart-total">
      ...
      <p>grand total : <span><?php echo $prictotale." DT"; ?></span></p>
      <a href="addorders.php?table=<?php echo $table; ?>&sp=1" class="delete-btn" onclick="return confirm('checkout all orders from cart?');">checkout orders</a>
      </div>
   </div>
