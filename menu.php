...
?>
      ...
      <div class="box">
         ...
         <a class="cat"><?php echo $row['categorie']; ?></a>
         <div class="name"><?php echo $row['nom']; ?></div>
         <div class="flex">
            <div class="price"><?php echo $row['prix']; ?><span>DT</span><span></span></div>
            <input type="submit" class="delete-btn" onclick=" return add(<?php echo $row['id']; ?>,<?php echo $table; ?>);" value="add">
         </div>
